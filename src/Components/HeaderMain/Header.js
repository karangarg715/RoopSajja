...
export default function Homepage() {
    ...
    return (
        <React.Fragment>
            <section  style={{height:"auto",width:"100vw",backgroundColor:"grey",position:"relative",backgroundColor:"black"}}>
                <div style={{height:"10vh",width:"inherit",borderBottom:"2px solid gold",position:"relative"}}>
